...
boxplot(weight ~ group,                             # compare weight by group
		...
		col = c("blue2","red1","orange1"))        # set bar fill colors
```
...
According to the data above, the trt1 group had less overall growth than the control group and the trt2 group had more overall growth than the control
