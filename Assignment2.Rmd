...
boxplot(weight ~ group,                             # compare weight by group
		...
		col = c("blue","yellow","pink"))        # set bar fill colors
```
...
Plants grew the best in treatment two, compared with the control and treatment one. However, all three were very similar. 
