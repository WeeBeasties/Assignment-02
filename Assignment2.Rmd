...
boxplot(weight ~ group,                             # compare weight by group
		...
		col = c("red","white","blue"))        # set bar fill colors
```
...
This is an analysis of variance between the values of growth weights of three different plants.  The plants, ctrl, trt1, and trt2, have mean dry weights of 5.032, 4.661, and 5.526 respectively with ranges depicted by the above box-plots.
