...
boxplot(weight ~ group,                             # compare weight by group
		...
		col = c("red2","blue3","green2"))        # set bar fill colors
```
...
The recorded p-value is less than .05, meaning the null hypothesis can be rejected and the difference in treatments is statistically significant.
