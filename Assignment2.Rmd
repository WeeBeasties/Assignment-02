...
`r knitr::kable(aggregate(weight ~ group,                             # compare weight by group
...
boxplot(weight ~ group,                             # compare weight by group
		...
		col = c("red","blue","green"))        # set bar fill colors
```
...
Since our P-value, Pr>F, is less than 0.05 we reject the null hypothesis. This means that the statistical differences of the growth observed were due to the treatments and not by random chance. Conluding that trt2 is indeed effective at promoting plant growth and trt1 tends to lead to underdeveloped plant growth.
