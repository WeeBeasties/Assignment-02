...
boxplot(weight ~ group,                             # compare weight by group
		...
		col = c("red2","green2","yellow2"))        # set bar fill colors
```
...
>>**Summary:** The above results show dried weight of plants from a control group and two treatments. We see a p-value < 0.05 so the results are significant.
